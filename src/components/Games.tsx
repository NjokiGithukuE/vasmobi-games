...
//                 <a href=""><Button variant="outline">{game.btnDescription}</Button></a>
...
export const Games: React.FC = () => {
  ...
  const handleButtonClick = (gameName: string, btnDescription: string) => {
    if (btnDescription === "Coming Soon") {
      navigate("/coming-soon");
    } else if (btnDescription === "Play Now") {
          ...
          >
            <CardContent className="p-0">
              ...
              <div className="p-6">
                ...
                <Button 
                  variant="outline"
                  onClick={() => handleButtonClick(game.name, game.btnDescription)}
                >
                  {game.btnDescription}
                </Button>
              </div>
